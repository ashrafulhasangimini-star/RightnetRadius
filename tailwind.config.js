...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-1': 'linear-gradient(135deg, #ABDCFF 0%, #0396FF 100%)',
        'gradient-2': 'linear-gradient(135deg, #FEB692 0%, #EA5455 100%)',
      },
      boxShadow: {
        ...
        '7': '0px 10px 60px 0px rgba(0, 0, 0, 0.10)',
        '8': '0px 0px 20px 0px rgba(0, 0, 0, 0.10)',
      },
      dropShadow: {
